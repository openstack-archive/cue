...
class TestCueObjects(base.UnitTestCase):
    ...
    def test_as_dict(self):
        """test conversion of Cluster object to dict."""
    ...
    def test_as_dict_invalid_field(self):
    ...
    def test_obj_get_changes(self):
        ...
        self.assertEqual(models.Status.DELETING, cluster_dict['status'])
        # check for an unchanged field
        self.assertRaises(KeyError, lambda: cluster_dict['name'])

    def test_obj_get_changes_invalid_field(self):
    ...
    def test_from_db_object_invalid_field(self):
