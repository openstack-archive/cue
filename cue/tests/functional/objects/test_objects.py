...
class ClusterObjectsApiTests(base.FunctionalTestCase):
...
class NodeObjectsApiTests(base.FunctionalTestCase):
    def test_get_nodes_by_cluster_id(self):
        """Tests get nodes by cluster id from Nodes objects API."""


class EndpointObjectsApiTests(base.FunctionalTestCase):
