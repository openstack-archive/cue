...
class ClusterObjectsTests(base.FunctionalTestCase):
    ...
    def test_update_cluster(self):
        ...
        self.assertEqual('test_cluster', updated_cluster.name)
