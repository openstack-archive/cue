...
class BrokerObjectsTests(base.FunctionalTestCase):
    ...
    def create_object_broker_metadata(self):
        """Create broker_metadata object."""
        new_broker = objects.Broker(**func_utils.get_test_broker())
        new_broker.create_broker(self.context)
        test_metadata_dict = func_utils.get_test_broker_metadata()
    ...
    def test_broker_metadata_object_generation(self):
        ...
        metadata_dict = func_utils.get_test_broker_metadata()
    ...
    def test_get_broker_metadata_by_broker_id(self):
        """Tests get broker_metadata by broker_id from BrokerMetadata objects
         ...
         API.
         """
        broker_metadata = self.create_object_broker_metadata()
        metadata = objects.BrokerMetadata.get_broker_metadata_by_broker_id(
            self.context, broker_metadata.broker_id)
        self.validate_broker_metadata_values(broker_metadata,
                                             metadata[0])
    ...
    def test_get_broker_metadata_by_invalid_broker_id(self):
        ...
        invalid broker id.
        """
        self.create_object_broker_metadata()
    ...
    def test_get_image_id_by_nonexistent_broker_name(self):
        ...
        self.assertRaises(sql_exception.NoResultFound,
