...
class GetRabbitVmStatusTest(base.TestCase):
    ...
    def test_get_rabbit_status(self):
        ...
        self.assertEqual(node_before.id, endpoint.node_id, "invalid endpoint "
                                                           "node id reference")
        uri = GetRabbitVmStatusTest.task_store['vm_ip']
        uri += ':' + GetRabbitVmStatusTest.task_store['rabbit_port']
