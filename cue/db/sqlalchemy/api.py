...
class Connection(api.Connection):
    ...
    def get_image_id(self, context, broker_name):
        ...
        if len(selected_image) is not 1:
            raise exception.NotFound(_("No Image found for the given broker"))

        image_id = selected_image[0]['value']
        return image_id