...
class NeutronClientPlugin(clients.ClientPlugin):

    exceptions_module = exceptions

    def _create(self):
        endpoint_type = clients._get_client_option('neutron', 'endpoint_type')

        args = {
            'service_type': 'network',
            'endpoint_type': endpoint_type,
            'ca_cert': clients._get_client_option('neutron', 'ca_file'),
            'insecure': clients._get_client_option('neutron', 'insecure'),
