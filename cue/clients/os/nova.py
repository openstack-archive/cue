...
class NovaClientPlugin(clients.ClientPlugin):
    ...
    def _create(self):
        ...
        endpoint_type = clients._get_client_option('nova', 'endpoint_type')
        args = {
            ...
            #                                          'http_log_debug'),
            'cacert': clients._get_client_option('nova', 'ca_file'),
            'insecure': clients._get_client_option('nova', 'insecure'),
        }
