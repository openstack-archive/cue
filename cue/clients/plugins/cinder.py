...
class CinderClientPlugin(plugins.ClientPlugin):
    ...
    def get_volume_api_version(self):
        ...
        endpoint_type = clients.get_client_option('cinder', 'endpoint_type')
        try:
    ...
    def _create(self):
        ...
        endpoint_type = clients._get_client_option('cinder', 'endpoint_type')
        args = {
            ...
            'api_key': None,
            'endpoint_type': endpoint_type,
            'http_log_debug': clients.get_client_option('cinder',
                                                         'http_log_debug'),
            'cacert': clients.get_client_option('cinder', 'ca_file'),
            'insecure': clients.get_client_option('cinder', 'insecure')
        }
