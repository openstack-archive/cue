...
class BrokerCommands(base.Commands):
    ...
    - To add a new metadata for a broker; get broker_id using 'broker list'
      and use the id in th command 'broker add_metadata'.
    """
    def __init__(self):
    ...
    def list(self):
        ...
        broker_list = broker_obj.get_brokers(self.context)
    ...
    def add_metadata(self, broker_id, image_id, sec_group):
        ...
        if image_id is not None:
            ...
            metadata.add_broker_metadata(self.context)
    ...
    def list_metadata(self, broker_id):
        ...
        metadata = objects.BrokerMetadata(**broker_id)
        broker_metadata = metadata.get_broker_metadata_by_broker_id(
            self.context)
