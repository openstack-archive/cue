...
class BrokerCommands(base.Commands):
    ...
    @base.args('--name', dest='broker_name', help="Broker name")
    @base.args('--active', dest='active', help="Broker active status")
    ...
    @base.args('--id', dest='broker_id', help='Broker id')
    @base.args('--name', dest='broker_name', nargs='?', help='Broker name')
    @base.args('--active', dest='active', nargs='?',
               help='Broker active status')
