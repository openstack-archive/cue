...
class BrokerMetadata(base.CueObject):
    ...
    def add_broker_metadata(self, context):
    ...
    def get_broker_metadata_by_broker_id(self, context):
        ...
        """
        broker_id = self.__getitem__('broker_id')
        db_broker_metadata = self.dbapi.get_broker_metadata_by_broker_id(
            context, broker_id)
    ...
    def delete_broker_metadata(self, context):
        ...
        """
        broker_metadata_id = self.__getitem__('id')
        self.dbapi.delete_broker_metadata(context, broker_metadata_id)

    @classmethod
    def get_image_id(cls, context, broker_name):
        ...
        """
        image_id = cls.dbapi.get_image_id(context, broker_name)
