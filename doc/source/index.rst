...
Cue is a resilient messaging broker provisioning service for OpenStack. Cue is
a message broker provisioning service for Openstack. Its goal is to simplify
and automate the complex tasks of provisioning, management, and administration
of message brokers. Cue is designed to provide API, CLI, and UI based
management of open source brokers such as RabbitMQ and Kafka. Because it’s
designed to be pluggable, proprietary message brokers can also be delivered as
a service through Cue.  The service will provide resource isolation at the VM
level, and does not attempt to implement multi-tenancy at the message broker
layer.
...
User & Contributors of Cue
--------------------------

The following sections describe Cue for users & contributors of the project.
